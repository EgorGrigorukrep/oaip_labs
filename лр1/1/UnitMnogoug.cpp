 ...
 void __fastcall TFormMnogoug::BitBtn2Click(TObject *Sender)
{
	...
	FormMnogoug->Label2->Caption="Координаты записаны";
...
void __fastcall TFormMnogoug::Button4Click(TObject *Sender)
{
	...
	FormMnogoug->Label2->Caption="Координаты";
...
void __fastcall TFormMnogoug::ComboBox1Change(TObject *Sender)
{
	...
	if (ComboBox1->Text=="Линия") {KolVersh=2;}
	if (ComboBox1->Text=="3-угольник") {KolVersh=3;}
	if (ComboBox1->Text=="4-угольник") {KolVersh=4;}
	if (ComboBox1->Text=="5-угольник") {KolVersh=5;}
	if (ComboBox1->Text=="6-угольник") {KolVersh=6;}
	if (ComboBox1->Text=="7-угольник") {KolVersh=7;}
	if (ComboBox1->Text=="8-угольник") {KolVersh=8;}
	if (ComboBox1->Text=="9-угольник") {KolVersh=9;}
	if (ComboBox1->Text=="10-угольник") {KolVersh=10;}
